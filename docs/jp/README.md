  ...
  - header: 安全なプログラム設計
    ...
    highlights:
      - title: データはあなたが管理します
        ...
        details: データはローカルデバイスに保存され、クラウドサービスやサードパーティーのプラットフォームに依存せず、データを自由に制御できます
      - title: 私達はあなたのデータを保護します
...
Snap Hutao はis currently using sponsored software from the following service providers.
